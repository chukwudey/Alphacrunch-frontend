    ...
    <div className=' flex justify-start items-center'>
      ...
      <div className=' w-full md:w-7/12'>
        <form className=' mx-auto p-8 block'>
            ...
            <div className=' flex justify-start gap-4 w-4/6 mb-8 mx-auto'>
              <input type="radio" className=' rounded-none' name="TC" value="TC" required/>
              <p>I agree with the <Link to=''><span className=' text-yellow-500 cursor-pointer'>terms and conditions</span></Link>.</p>
            </div>
            <button type='submit' className=' text-white block bg-black cursor-pointer rounded-lg px-6 py-4 w-4/6 mx-auto text-center'>Sign Up</button>
