...
const Overview = () => {
  ...
  return (
    <div className=' flex justify-between pl-8 pr-4 pt-8'>
      <div>
        <h1 className=' font-Space-Grotesk font-bold text-lg'>Dashboard</h1>
        <div>
      ...
      <div>
        ...
        <div className=' bg-gold-card bg-center bg-contain bg-no-repeat w-60 h-40 pt-8 px-4'>
          ...
          <div className=' flex space-x-1 w-full mx-auto justify-between'>
            <Link className='text-white text-center text-xs w-1/2 bg-black px-4 py-2 rounded-l-md'>
              <p>WITHDRAW</p>
            </Link>

            <Link className=' text-white text-center text-xs w-1/2 bg-black px-4 py-2 rounded-r-md'>
              <p>FUND</p>
            </Link>
          </div>
        </div>
